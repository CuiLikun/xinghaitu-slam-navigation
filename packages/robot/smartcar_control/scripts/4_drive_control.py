...
class FourDriveCar:
    def __init__(self):
        ...
        self.acc_vel = rospy.get_param('~acc_vel', rospy.get_param('~acc_vel', rospy.get_param('/acc_vel', 0.1)))
        self.acc_theta = rospy.get_param('~acc_theta', rospy.get_param('~acc_theta', rospy.get_param('/acc_theta', 0.7)))
        self.dist_axis = rospy.get_param('~dist_axis', rospy.get_param('~dist_axis', rospy.get_param('/dist_axis', 0.52)))
        self.dist_wheel = rospy.get_param('~dist_wheels', rospy.get_param('~dist_wheels', rospy.get_param('/dist_wheel', 0.35)))
        self.wheel_radius = rospy.get_param('~diameter_wheel', rospy.get_param('~diameter_wheel', rospy.get_param('/diameter_wheel', 0.17))) * 0.5
